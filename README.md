...
| Projet | Description | Stack |
|---|---|---|
| [Pipeline MLOps](https://github.com/Airohh/Proths) | Train → Deploy → Monitor → Retrain de bout en bout | MLflow, DVC, FastAPI, Docker, Prometheus, Grafana |

## Stack

`Python` · `SQL` · `PySpark` · `MLflow` · `Docker` · `FastAPI` · `GitLab CI / GitHub Actions` · `Prometheus / Grafana` · `Qdrant` · `Snowflake` · `Terraform`
